...
public class LaberintoBista extends JFrame implements Observer{
	...
	public LaberintoBista() {
	    ...
	    // Panel personalizado con la imagen de fondo
	    ...
	    // Añadimos la matriz (panel) en el centro
	...
	private JPanel sortuLaberintoa() {
	    if(matrizea == null) {
	        matrizea = new JPanel();
	        matrizea.setLayout(new GridLayout(11, 17, 0, 0));
	        matrizea.setOpaque(false);  // Para que se vea el fondo del contentPane
	        hasieratuGelaxkak();
	    }
	    return matrizea;
	}
