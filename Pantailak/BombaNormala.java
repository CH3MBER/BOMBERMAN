...
public class BombaNormala extends BombaStrategy {
	...
	protected void apurtu() {
		...
		if(getX()-1>=0 && !(LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka(getY()*17+(getX()-1)).getMota() == 1)) {
			lE.getSuLista().add(new Sua(getX()-1,getY()));
			if (lE.getBomberman().getY()*17+lE.getBomberman().getX() == getY()*17+(getX()-1)) {
				LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka(getY()*17+(getX()-1)).setMota(14);
				lE.getBomberman().setBizitza(false);
				hil = true;
			}
				...
				LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka(getY()*17+(getX()-1)).setMota(4);
			}
			else if (!(LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka(getY()*17+(getX()-1)).getMota() == 3))
				LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka(getY()*17+(getX()-1)).setMota(4);
			LaberintoEredua.getLabEredua().getLabMota().getbZerr().eztandaEginPosizioan(getX()-1, getY());
		}
		if(getX()+1<=16 && !(LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka(getY()*17+(getX()+1)).getMota() == 1)) {
			lE.getSuLista().add(new Sua(getX()+1,getY()));
			if (lE.getBomberman().getY()*17+lE.getBomberman().getX() == getY()*17+(getX()+1)) {
				LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka(getY()*17+(getX()+1)).setMota(14);
				lE.getBomberman().setBizitza(false);
		...
		if(getY()-1>=0 && !(LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka((getY()-1)*17+getX()).getMota() == 1)) { 
			lE.getSuLista().add(new Sua(getX(),getY()-1));
			if (lE.getBomberman().getY()*17+lE.getBomberman().getX() == (getY()-1)*17+getX()){
				LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka((getY()-1)*17+getX()).setMota(14);
				lE.getBomberman().setBizitza(false);
				hil = true;
			}
				...
				LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka((getY()-1)*17+getX()).setMota(4);
			}
			else if (!(LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka((getY()-1)*17+getX()).getMota() == 3))
				LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka((getY()-1)*17+getX()).setMota(4);
			LaberintoEredua.getLabEredua().getLabMota().getbZerr().eztandaEginPosizioan(getX(), getY()-1);
		}
		if(getY()+1<=10 && !(LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka((getY()+1)*17+getX()).getMota() == 1)) {
			lE.getSuLista().add(new Sua(getX(),getY()+1));
			if (lE.getBomberman().getY()*17+lE.getBomberman().getX() == (getY()+1)*17+getX()) {
				LaberintoEredua.getLabEredua().getLabMota().getGelaZerr().aurkituGelaxka((getY()+1)*17+getX()).setMota(14);
				lE.getBomberman().setBizitza(false);
